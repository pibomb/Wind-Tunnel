...
public class InputSignal2 extends JFrame {
	...
	public InputSignal2() {
		...
		contentPane.add(AnalogPinStatus, BorderLayout.EAST);
		AnalogPinStatus.setPin(3);
